            ...
            if (Request.QueryString.Count > 0)
            {
                ...
                if (checkSignature)
                {
                    if (vnp_ResponseCode == "00" && vnp_TransactionStatus == "00")
                    {
                        ...
                        if (itemOrder != null)
                        {
                            itemOrder.IsPaid = true;//đã thanh toán
        ...
        public ActionResult CheckOut(OrderViewModel req)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cart != null)
                {
                    ...
                    var userId = User.Identity.GetUserId(); // Nếu bạn sử dụng ASP.NET Identity
                    ...
                    {
                        var product = db.Products.FirstOrDefault(p => p.Id == sp.ProductId);
                        if (product != null)
                        {
